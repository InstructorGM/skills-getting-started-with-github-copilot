...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development, scrimmages, and basketball tournaments",
    ...
    "Drama Club": {
        "description": "Acting workshops, stage performance, and school productions",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["amelia@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Society": {
        "description": "Structured debates, public speaking, and critical reasoning",
